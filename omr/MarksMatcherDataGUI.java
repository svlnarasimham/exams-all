...
public class MarksMatcherDataGUI extends JDialog implements ActionListener
{
	...
	public void getData(String baseFolder)
	{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			String x = utility.Utilities.chooseFile(baseFolder, Utilities.OPEN, Utilities.FILES, "..*", "Choose Code Vs Rollno file");
			if(x != null)
			{
		...
		{
			String x = utility.Utilities.chooseFile(baseFolder, Utilities.OPEN, Utilities.FILES, "..*", "Choose Code Vs Marks file");
			if(x != null)
			{
